        ...
        <div className="bg-white border border-slate-200 shadow-lg rounded-2xl p-6 md:p-10">
          ...
          <div className="space-y-8 text-slate-700 leading-relaxed">
            <div>
              ...
              <p>
                By accessing or using MeroGhar, you agree to these Terms and Conditions. If you do not agree, please do not use the app.
            ...
            <div>
              ...
              <p>
                MeroGhar is a rental management platform that helps users discover properties, schedule visits, exchange messages,
                request leases, make deposit or rent payments, and manage maintenance and notifications. MeroGhar provides the platform,
            ...
            <div>
              ...
              <p>
                ...
                activities carried out through your account. MeroGhar may suspend or restrict accounts involved in fraud, abuse,
            ...
            <div>
              ...
              <p>
                Lease workflows in MeroGhar are digital tools for managing rental processes. Users are responsible for understanding
            ...
            <div>
              ...
              <p>
                Payments may be processed through third-party providers such as eSewa and Khalti. MeroGhar does not store full payment
            ...
            <div>
              ...
              <p>
                ...
                prohibited. Reviews should be honest and based on genuine experience. MeroGhar may remove content or limit accounts
            ...
            <div>
              ...
              <p>
                MeroGhar may suspend, restrict, or terminate access for policy breaches, misuse, suspected fraud, or legal
            ...
            <div>
              ...
              <p>
                To the maximum extent allowed by law, MeroGhar is not liable for indirect, incidental, or consequential losses arising
            ...
            <div>
              ...
              <p>
                ...
                last updated date and, where appropriate, by in-app notice. Continued use of MeroGhar after changes indicates
            ...
            <div>
              ...
              <p>
                For questions related to these terms, contact us at deuza@meroghar.com or +977 9702004193.
              </p>
            </div>
          </div>
        </div>
